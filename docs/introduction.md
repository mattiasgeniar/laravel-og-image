...
The approach of using a `<template>` tag to define OG images inline with your page's own CSS is inspired by [OGKit](https://ogkit.dev) by [Peter Suhm](https://x.com/petersuhm). If you don't want to self-host the generation of OG images, look no further than OG Kit.
