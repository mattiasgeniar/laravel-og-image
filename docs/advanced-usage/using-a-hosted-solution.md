---
title: Using a hosted solution
weight: 7
---

The approach of using a `<template>` tag to define OG images inline — so they inherit your page's own CSS, fonts, and Vite assets — is inspired by [OG Kit](https://ogkit.dev) by [Peter Suhm](https://x.com/petersuhm).
